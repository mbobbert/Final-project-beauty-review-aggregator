 ...
 */
{
    ...
    if(!empty($html)){ //if any html is actually returned
        ...
        //get all the product NUMBER OF RATINGS per STAR
        $sephora_serums_ratings_per_star = $sephora_serums_indiv_xpath->query('//button[@class="css-fisw11"]');

        $product_desc_and_nr_of_ratings[] = [
            $sephora_serums_description[0]->nodeValue,
            $sephora_serums_nr_of_ratings[0]->nodeValue,
            $sephora_serums_ratings_per_star[0]->nodeValue
        ];
